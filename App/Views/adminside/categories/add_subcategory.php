            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        echo form_open(ADMIN_ADD_SUB_CATEGORIES_LINK,$attributes);
                       ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea class="field form-control col-md-7 col-xs-12" rows="5" placeholder="Enter description" name="category_description" required=""></textarea>
                                </div>
                            </div>                                                                                                                                                                                                                                                   
